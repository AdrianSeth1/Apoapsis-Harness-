...
def _manifest() -> PilotManifest:
    ...
    for name in (
        "slice7-crisis-atlas-pilot-manifest-v8.json",
        "slice7-crisis-atlas-pilot-manifest-v7.json",
...
class NegativeControlsAreExecutedNotDescribedTests(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.manifest = _manifest()
        lock_path = QUALIFICATION / "slice7-crisis-atlas-pilot-lock-v8.json"
        ...
        self.manifest_path = (
            QUALIFICATION / "slice7-crisis-atlas-pilot-manifest-v8.json"
        )
