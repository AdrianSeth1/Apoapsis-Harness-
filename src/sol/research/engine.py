...
from sol.config import ResearchConfig
from sol.models.base import ModelOperation
from sol.research.audit import ResearchAuditStore
...
from sol.research.security import PromptInjectionDetector, quarantine
from sol.research.sources.base import ResearchSource
from sol.research.trigger import ResearchTriggerDecision, ResearchTriggerEngine
    ...
    def __init__(
        ...
        *,
        ...
        self.cache = cache or ResearchCache(
            self.project_root / ".sol" / "research-cache.db"
        )
...
"""
    ...
    def _dependency_fingerprint(self) -> str:
        ...
        for path in sorted(
            ...
            if ".git" in path.parts or ".sol" in path.parts:
                continue
