...
def export_frontier_planning_package(
    ...
    *,
    ...
    package = build_frontier_planning_request_package(
        ...
        research_triggered=session.research_triggered,
        research_brief=session.research_brief,
        research_evidence_ids=session.research_evidence_ids,
        research_audit_directory=session.research_audit_directory,
