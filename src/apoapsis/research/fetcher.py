...
from apoapsis.config import ResearchSecurityConfig
...
class _RestrictedRedirectHandler(urllib.request.HTTPRedirectHandler):
    ...
    def redirect_request(self, req, fp, code, msg, headers, newurl):
        ...
        prior_count = getattr(req, "_apoapsis_redirect_count", 0)
        ...
        if redirected is not None:
            setattr(redirected, "_apoapsis_redirect_count", count)
...
def _worker_initializer() -> None:
    ...
    isolated_directory = tempfile.mkdtemp(prefix="apoapsis-research-fetch-")
