...
- Slice 7P.1b Crisis Atlas pilot case package (deterministic only; the seed
  clone and object types are real, the checkpoint half is an injected probe;
  no model, server, container or network):
